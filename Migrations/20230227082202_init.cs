        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tattoos_Categories_CategoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TattoId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TattoosId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rezervations_AspNetUsers_CustomersId",
                        column: x => x.CustomersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Rezervations_Employers_EmployersId",
                        column: x => x.EmployersId,
                        principalTable: "Employers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rezervations_Tattoos_TattoosId",
                        column: x => x.TattoosId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rezervations_CustomersId",
                table: "Rezervations",
                column: "CustomersId");

            migrationBuilder.CreateIndex(
                name: "IX_Rezervations_EmployersId",
                table: "Rezervations",
                column: "EmployersId");

            migrationBuilder.CreateIndex(
                name: "IX_Rezervations_TattoosId",
                table: "Rezervations",
                column: "TattoosId");

            migrationBuilder.CreateIndex(
                name: "IX_Tattoos_CategoriesId",
                table: "Tattoos",
                column: "CategoriesId");
        }
